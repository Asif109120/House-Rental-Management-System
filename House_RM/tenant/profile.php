...
try {
    ...
    // Get user details
    $query = "SELECT * FROM users WHERE id = :user_id AND user_type = 'tenant'";
    ...
    // Get total bookings
    $query = "SELECT COUNT(*) as total_bookings FROM bookings WHERE tenant_id = :tenant_id";
    $stmt = $db->prepare($query);
...
.profile-header {
    background: linear-gradient(135deg, #00ac69 0%, #00ba81 100%);
    color: white;
    padding: 3rem 2rem;
    text-align: center;
    position: relative;
        ...
        <div class="col-12">
            ...
            <div class="profile-section">
                <div class="profile-header">
                    ...
                    <p class="mb-0 opacity-75">Tenant</p>
                </div>
