...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="../index.php">
            <i class="fas fa-shield-alt me-2"></i>HRMS Admin
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex">
                <div class="dropdown">
                    <button class="btn btn-link text-light text-decoration-none dropdown-toggle" type="button" id="userDropdown" data-bs-toggle="dropdown">
